...
/// <summary>
/// This is the Jelly sprite class. Attach to any Unity sprite, and at runtime the sprite will move and
/// distort under the influence of soft body physics.
/// 
/// THE JellySprite CLASS, WHICH THIS CLASS INHERITS FROM, HAS BEEN MODIFIED BY MERT LENGERLIOGLU FOR USE IN FAT BOTTOM NINJA
/// THE CHANGES ARE FLAGGED BY DEBUG.LOG MESSAGES 
/// CHECK JellySprite script for any modifications if there are any errors.
/// 
/// </summary>

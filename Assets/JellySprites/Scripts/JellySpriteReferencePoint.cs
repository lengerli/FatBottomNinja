...
public class JellySpriteReferencePoint : MonoBehaviour 
{
	...
	//public JellyRefPointBounding refPointBounder; //Added by Mert
	public JellySprite.ReferencePoint refPoint; 
    ...
    void Start()
    {
		...
		{
			refPointBounder = gameObject.AddComponent<JellyRefPointBounding>();
			refPoint.AddRefPointBounder(refPointBounder);
		}
		*/
    }
